...
/// </summary>
public class NextRunStrategy_Hourly : NextRunStrategy
{
    /// <summary>
    ...
    /// <summary>
    /// Calculates the next execution time by adding exactly one hour to the <see cref="NextRunStrategy.LastTargetDTM"/>.
    /// </summary>
