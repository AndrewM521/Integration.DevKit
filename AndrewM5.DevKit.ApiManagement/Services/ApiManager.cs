...
public class ApiManager : IApiManager
{
    ...
    public ApiManager(IOptions<ApiManagerSettings> settings, IHttpClientFactory httpFactory, ICustomLoggerManager loggerManager)
    {
        if (settings == null)
        {
        ...
        if (RuntimeSettings.MaxHttpClients < 0)
        {
            RuntimeSettings.MaxHttpClients = int.MaxValue;
        }

        if (RuntimeSettings.DefaultTimeoutSeconds < 0)
        {
            RuntimeSettings.DefaultTimeoutSeconds = -1;
        }
